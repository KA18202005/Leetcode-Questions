<h2><a href="https://leetcode.com/problems/minimum-cost-to-set-cooking-time/?envType=problem-list-v2&envId=d89uu4s5">2266. Minimum Cost to Set Cooking Time</a></h2><h3>Medium</h3><hr><p>A generic microwave supports cooking times for:</p>
