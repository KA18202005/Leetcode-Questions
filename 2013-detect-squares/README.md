<h2><a href="https://leetcode.com/problems/detect-squares/?envType=problem-list-v2&envId=d89uu4s5">2139. Detect Squares</a></h2><h3>Medium</h3><hr><p>You are given a stream of points on the X-Y plane. Design an algorithm that:</p>
