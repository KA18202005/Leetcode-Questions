<h2><a href="https://leetcode.com/problems/my-calendar-i/?envType=problem-list-v2&envId=d89uu4s5">729. My Calendar I</a></h2><h3>Medium</h3><hr><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>double booking</strong>.</p>
