<h2><a href="https://leetcode.com/problems/stock-price-fluctuation/?envType=problem-list-v2&envId=d89uu4s5">2161. Stock Price Fluctuation </a></h2><h3>Medium</h3><hr><p>You are given a stream of <strong>records</strong> about a particular stock. Each record contains a <strong>timestamp</strong> and the corresponding <strong>price</strong> of the stock at that timestamp.</p>
